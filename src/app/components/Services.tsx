...
import { PhotoChatMessage,VideoBar,VideoChatMessage,Gradient } from "./design/ServicesShort";
            ...
            <div className="container">
                ...
                mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] ">
                        <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                            <Image src={service1} width={800} height={730} className="w-full h-full object-cover" alt="Smart Ai" />
                        </div>

                        <div className="relative z-1 max-w-[17rem] ml-auto" >
                            <h4>Smartest AI</h4>
                            <p>Brainwave inlocks the potential of AI-powered application</p>
                            <ul className="body-2">
                                {brainwaveServices.map((item, index) => (
                                    <li className="flex items-start py-4 border-t border-n-6" key={index}>
                                        <Image src={check} width={24} height={24} alt="check-icon" />
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <Image src={service3} width={520} height={400} alt="Scary robot" className="w-full h-full object-cover"/>
